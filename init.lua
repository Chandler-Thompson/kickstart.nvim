...
--  See `:help hlsearch`
vim.keymap.set('n', '<Esc>', '<cmd>nohlsearch<CR>', { desc = 'Clear search highlights in normal mode' })
...
require('lazy').setup({
        ...
        handlers = {
          ...
          jdtls = function()
            ...
            require('lspconfig').jdtls.setup {
              -- custom nvim-java configuration here
            }
          end,
        },
      }
  ...
  },
  {
    ...
    opts = {
      ...
      --
      -- Current Default Settings for Reference:
      --
      -- "auto" | "roslyn" | "off"
      --
  ...
  { -- Highlight, edit, and navigate code
    ...
    opts = {
      ensure_installed = { 'bash', 'c', 'diff', 'go', 'html', 'lua', 'luadoc', 'markdown', 'markdown_inline', 'query', 'vim', 'vimdoc', 'java', 'gdscript' },
